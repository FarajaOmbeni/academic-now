  ...
  return (
    <div className="mt-24 mb-40 container mx-auto sm:px-16 px-6">
      ...
      <div className="p-6 bg-[url('./assets/testimonialBg.png')] relative bg-cover rounded-[26px] mt-14">
        <p className="text-white text-center text-[18px] font-normal leading-[28px] hidden sm:block">
          {" "}
          {testimonialText}
        </p>

        <p className="sm:hidden text-white text-center text-[18px] font-normal leading-[28px]">
          {isExpanded ? (
            <>
              {testimonialText}
              <button
        ...
        <img
          src={quoteIcon}
          alt="quote icon"
          className="absolute top-[-10%] md:top-[-15%] left-[3%] w-[54px] h-[54px]"
        />
